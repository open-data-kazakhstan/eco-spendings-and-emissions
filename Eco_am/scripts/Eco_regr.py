...
for area, area_data in grouped_data:
    ...
    y = area_data['Выделенный бюджет на защиту экологии'].values
...
predictions_df = predictions_df.melt(id_vars='Год', var_name='Регион', value_name='Выделенный бюджет на защиту экологии')
