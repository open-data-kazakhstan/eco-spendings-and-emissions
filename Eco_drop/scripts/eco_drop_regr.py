...
# Read kazpop.csv
data = pd.read_csv(r'C:\Users\USER\Desktop\Eco_project\Eco_drop\data\unpiv_part2.csv')
...
for area, area_data in grouped_data:
    ...
    y = area_data['Выброс загрезнений(тыс.тонн)'].values
...
predictions_df = predictions_df.melt(id_vars='Год', var_name='Регион', value_name='Выброс загрезнений(тыс.тонн)')
...
df_sorted.to_csv(r'C:\Users\USER\Desktop\Eco_project\Eco_drop\data\eco_drop_regr.csv')