...
# Read the initial 
csv = r"C:\Users\USER\Desktop\project 1_part2\data\part2.csv"
df = pd.read_csv(csv)
...
df_unpivot = pd.melt(df, id_vars='Unnamed: 0', value_vars=[ '2005.0', '2006.0',
                                                           ...
                                                           '2021.0', '2022.0'])
df_unpivot.rename(columns={"Unnamed: 0": "Регион", "variable": "Год", "value": "Выброс загрезнений(тыс.тонн)"}, inplace=True)
...
df_unpivot.to_csv(r'C:\Users\USER\Desktop\Data\practice\unpiv_part2.csv', index=False)